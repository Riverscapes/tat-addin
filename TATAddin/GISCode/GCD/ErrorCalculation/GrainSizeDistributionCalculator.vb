...
Namespace GISCode.GCD
    ...
    Public Module GrainSizeDistributionCalculator
        ...
        Private Function Di(ByVal x1 As Double, ByVal x2 As Double, ByVal y1 As Double, ByVal y2 As Double, ByVal grainSize As UInt16) As Double
        ...
        Private Sub GrainSizeDistributionLogic(ByVal pCumulativeSumDictionary As Dictionary(Of GrainSizeClasses, UInteger),
            ...
            Select Case bin
                ...
                Case Else
                    ...
                    ElseIf pEnumerableRange.Contains(90) And Not pGrainSizeDistributionResults.D16 = Nothing And Not pGrainSizeDistributionResults.D50 = Nothing And Not pGrainSizeDistributionResults.D84 = Nothing Then
                        pGrainSizeDistributionResults.D90 = Di(pBoundsPair.LowerBound, pBoundsPair.UpperBound, pCumulativeSumDictionary(bin), pCumulativeSumDictionary(bin + 1), 90)
                        'Continue Do

                    ElseIf pEnumerableRange.Contains(84) And pEnumerableRange.Contains(90) And Not pGrainSizeDistributionResults.D16 = Nothing And Not pGrainSizeDistributionResults.D50 = Nothing Then
                        pGrainSizeDistributionResults.D84 = Di(pBoundsPair.LowerBound, pBoundsPair.UpperBound, pCumulativeSumDictionary(bin), pCumulativeSumDictionary(bin + 1), 84)
                        pGrainSizeDistributionResults.D90 = Di(pBoundsPair.LowerBound, pBoundsPair.UpperBound, pCumulativeSumDictionary(bin), pCumulativeSumDictionary(bin + 1), 90)
                        'Continue Do

                    ElseIf pEnumerableRange.Contains(50) And pEnumerableRange.Contains(84) And pEnumerableRange.Contains(90) And Not pGrainSizeDistributionResults.D16 = Nothing Then
                        pGrainSizeDistributionResults.D50 = Di(pBoundsPair.LowerBound, pBoundsPair.UpperBound, pCumulativeSumDictionary(bin), pCumulativeSumDictionary(bin + 1), 50)
                        pGrainSizeDistributionResults.D84 = Di(pBoundsPair.LowerBound, pBoundsPair.UpperBound, pCumulativeSumDictionary(bin), pCumulativeSumDictionary(bin + 1), 84)
                        pGrainSizeDistributionResults.D90 = Di(pBoundsPair.LowerBound, pBoundsPair.UpperBound, pCumulativeSumDictionary(bin), pCumulativeSumDictionary(bin + 1), 90)
                        'Continue Do
                    ...
                    ElseIf pEnumerableRange.Contains(50) And Not pGrainSizeDistributionResults.D16 = Nothing Then
                        pGrainSizeDistributionResults.D50 = Di(pBoundsPair.LowerBound, pBoundsPair.UpperBound, pCumulativeSumDictionary(bin), pCumulativeSumDictionary(bin + 1), 50)
        ...
        Public Sub CreateCDFPlot(ByVal pGrainSizeResults As GrainSizeDistributionResults, ByVal sOutputCDFPath As String)
            ...
            Dim sMetricText As String = String.Format("D16: {0}", Math.Round(pGrainSizeResults.D16, 1))
            ...
            sMetricText = String.Format("D50: {0}", Math.Round(pGrainSizeResults.D50, 1))
            ...
            sMetricText = String.Format("D84: {0}", Math.Round(pGrainSizeResults.D84, 1))
            ...
            sMetricText = String.Format("D90: {0}", Math.Round(pGrainSizeResults.D90, 1))

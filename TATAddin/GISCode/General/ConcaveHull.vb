...
Namespace GISCode
    ...
    Public Class ConcaveHull
        ...
        '    Dim sFGDBName As String = GISDataStructures.FileGeodatabase.GetSafeName(WorkspaceManager.WorkspacePath, "hull")
        '    Dim pWorkspace As IWorkspace = Nothing
        '    GISDataStructures.FileGeodatabase.CreateFileGdbWorkspace(sFGDBName, pWorkspace)
        ...
        Private Sub AggregatePoints(sFeatures As String, sOutputPolygon As String, fDistance As Double)
            ...
            Catch ex As Exception
                ...
                Throw ex
            End Try
            'GPDataManagement.AddField(fiAgPoints, "Method", "TEXT")
            'GPDataManagement.CalculateField_management(strPolyPath, "Method", strMethod)
        End Sub
